package com.celik.foodo.payment.service.messaging.listener.kafka;

import com.celik.foodo.kafka.consumer.KafkaConsumer;
import com.celik.foodo.kafka.order.avro.model.PaymentOrderStatus;
...
import com.celik.foodo.payment.service.domain.ports.input.message.listener.PaymentRequestMessageListener;
import com.celik.foodo.payment.service.messaging.mapper.PaymentMessagingDataMapper;
