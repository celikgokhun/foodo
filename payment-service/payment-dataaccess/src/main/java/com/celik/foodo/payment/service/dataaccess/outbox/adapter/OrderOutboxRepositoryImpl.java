package com.celik.foodo.payment.service.dataaccess.outbox.adapter;

import com.celik.foodo.domain.valueobject.PaymentStatus;
import com.celik.foodo.outbox.OutboxStatus;
import com.celik.foodo.payment.service.dataaccess.outbox.exception.OrderOutboxNotFoundException;
import com.celik.foodo.payment.service.dataaccess.outbox.mapper.OrderOutboxDataAccessMapper;
import com.celik.foodo.payment.service.dataaccess.outbox.repository.OrderOutboxJpaRepository;
import com.celik.foodo.payment.service.domain.outbox.model.OrderOutboxMessage;
import com.celik.foodo.payment.service.domain.ports.output.repository.OrderOutboxRepository;
