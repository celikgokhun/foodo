...
import com.celik.foodo.payment.service.dataaccess.outbox.entity.OrderOutboxEntity;
...
public class PaymentRequestMessageListenerTest {
    ...
    private PaymentRequest getPaymentRequest(String sagaId) {
        return PaymentRequest.builder()
                ...
                .paymentOrderStatus(com.celik.foodo.domain.valueobject.PaymentOrderStatus.PENDING)
