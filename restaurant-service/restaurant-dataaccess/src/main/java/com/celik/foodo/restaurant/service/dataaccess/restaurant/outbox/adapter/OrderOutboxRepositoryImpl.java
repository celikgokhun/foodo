package com.celik.foodo.restaurant.service.dataaccess.restaurant.outbox.adapter;

import com.celik.foodo.outbox.OutboxStatus;
import com.celik.foodo.restaurant.service.dataaccess.restaurant.outbox.exception.OrderOutboxNotFoundException;
import com.celik.foodo.restaurant.service.dataaccess.restaurant.outbox.mapper.OrderOutboxDataAccessMapper;
import com.celik.foodo.restaurant.service.dataaccess.restaurant.outbox.repository.OrderOutboxJpaRepository;
import com.celik.foodo.restaurant.service.domain.outbox.model.OrderOutboxMessage;
import com.celik.foodo.restaurant.service.domain.ports.output.repository.OrderOutboxRepository;
