package com.celik.foodo.kafka.consumer.config;

import com.celik.foodo.kafka.config.data.KafkaConfigData;
import com.celik.foodo.kafka.config.data.KafkaConsumerConfigData;
